...
### Further Readings
I have explained Falcon REST API with SQLObject in my post [here](https://shantanubhuruk.hashnode.dev/rest-api-using-falcon-and-sqlobject) which will act as our resource provider for the APIs. 
